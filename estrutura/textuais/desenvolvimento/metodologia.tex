...
%\par As amostras das 13 classes relacionadas a comida foram retiradas da base \textit{Food-101}, já as amostras das três classes não relacionadas com comida foram retiradas da base \textit{ImageNet}. Isso ocorreu devido a falta de amostras com as classes relacionadas com comida na base \textit{ImageNet}
